...
import { Receipt, Trash2, Package, Users, ChevronDown } from 'lucide-react';
    ...
    <div className="bg-white rounded-2xl shadow-lg mb-6 overflow-hidden">
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              {totalMeals > 0
                ? `${totalBillableMeals} platillo${totalBillableMeals !== 1 ? 's' : ''}${totalMeals > totalBillableMeals ? ` + ${totalMeals - totalBillableMeals} colación${totalMeals - totalBillableMeals > 1 ? 'es' : ''}` : ''}`
                : 'Sin platillos seleccionados'}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          {totalMeals > 0 && (
            <span className="text-lg font-bold text-red-600">${priceBreakdown.finalTotal.toFixed(2)}</span>
          )}
      ...
      >
        <div className="px-6 pb-6 space-y-6">
          {/* Order Info */}
          <div className="p-5 bg-gradient-to-br from-green-50 to-blue-50 border-2 border-green-300 rounded-xl">
